...
$Computerinfo.Rename("BETAWIN-APP01")
...
'@
Invoke-VMScript -VM $VM -ScriptText $VMBETAAPP01 -ScriptType Powershell -GuestUser $guestuser -GuestPassword $guestpassword -HostUser $hostuser -HostPassword $hostpassword
