...
$Computerinfo.Rename("BETAWIN-APP02")
...
'@
Invoke-VMScript -VM $VM -ScriptText $VMBETAAPP02 -ScriptType Powershell -GuestUser $guestuser -GuestPassword $guestpassword -HostUser $hostuser -HostPassword $hostpassword
