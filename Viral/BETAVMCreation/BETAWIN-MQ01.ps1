...
$Computerinfo.Rename("BETAWIN-MQ01")
'@
Invoke-VMScript -VM $VM -ScriptText $VMBETAMQ01 -ScriptType Powershell -GuestUser $guestuser -GuestPassword $guestpassword -HostUser $hostuser -HostPassword $hostpassword
