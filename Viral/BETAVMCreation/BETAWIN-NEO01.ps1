...
$Computerinfo.Rename("BETAWIN-NEO01")
'@
Invoke-VMScript -VM $VM -ScriptText $VMBETANEO01 -ScriptType Powershell -GuestUser $guestuser -GuestPassword $guestpassword -HostUser $hostuser -HostPassword $hostpassword
