...
$Computerinfo.Rename("BETAWIN-SQL01")
...
'@
Invoke-VMScript -VM $VM -ScriptText $VMBETASQL01 -ScriptType Powershell -GuestUser $guestuser -GuestPassword $guestpassword -HostUser $hostuser -HostPassword $hostpassword
