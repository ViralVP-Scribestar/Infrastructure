...
$Computerinfo.Rename("BETAWIN-WEB01")
...
'@
Invoke-VMScript -VM $VM -ScriptText $VMBETAWEB01 -ScriptType Powershell -GuestUser $guestuser -GuestPassword $guestpassword -HostUser $hostuser -HostPassword $hostpassword
