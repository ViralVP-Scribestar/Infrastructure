...
try {
        ...
        Send-MailMessage -From "DoNotReply@scribestar.com" -To "Viral.Patel@scribestar.com" -Subject "New VM Creation Fail" -Attachments $workingpath1 -SmtpServer $smtpserver
         }
...
try {
        ...
        Send-MailMessage -From "DoNotReply@scribestar.com" -To "Viral.Patel@scribestar.com" -Subject "Network Label Error" -Attachments $workingpath2 -SmtpServer $smtpserver
...
try {
        New-HardDisk -VM $Name -CapacityGB $CapacityGB -StorageFormat $StorageFormat -Persistence Persistent -ErrorAction $ErrorActionPreference
                    ...
                    Send-MailMessage -From "DoNotReply@scribestar.com" -To "Viral.Patel@scribestar.com" -Subject "New HardDisk Error" -Attachments $workingpath5 -SmtpServer $smtpserver
...
'@
Invoke-VMScript -VM $VM -ScriptText $VMBETAWEB02 -ScriptType Powershell -GuestUser $guestuser -GuestPassword $guestpassword -HostUser $hostuser -HostPassword $hostpassword
